...
if ($hassiteconfig) {
    $ADMIN->add('localplugins', new admin_category('local_recertify_cat',
    ...
    $settings = new admin_settingpage('local_recertify_settings',
    ...
    $settings->add(new admin_setting_configcheckbox(
        ...
        get_string('wipeassignments', 'local_recertify'), '', 0));

    $settings->add(new admin_setting_configcheckbox(
        'local_recertify/wipequizattempts',
        get_string('wipequizattempts', 'local_recertify'), '', 0));

    $settings->add(new admin_setting_configcheckbox(
        'local_recertify/wipescormtracks',
        get_string('wipescormtracks', 'local_recertify'), '', 0));

    $settings->add(new admin_setting_configcheckbox(
        'local_recertify/notifyonreset',
        get_string('notifyonreset', 'local_recertify'), '', 1));

    $settings->add(new admin_setting_configcheckbox(
        'local_recertify/enableauditlog',
        get_string('enableauditlog', 'local_recertify'), '', 1));
