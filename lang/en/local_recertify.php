...
$string['intervalmonths_help'] = 'How many months after a learner\'s enrolment start date the first reset falls, and the gap between resets after that. Must be at least 1.';
...
$string['scheduletype_help'] = 'A relative schedule resets each learner on the anniversary of their own enrolment. A fixed schedule resets everyone in the course on the same calendar date each year.';
